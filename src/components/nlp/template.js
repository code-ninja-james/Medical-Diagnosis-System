  ...
  return new Promise((resolve) => {
    resolve(html`
      ...
      <div class="card-text">
        ...
        <p class="text-muted small">
          <i class="fa fa-info-circle"></i> This screen uses NLP engine to find symptoms in a written text.
          Evidence found in text will be marked as initial which is important to the engine. 
